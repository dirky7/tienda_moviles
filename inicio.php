    ...
    <main>
        <ul class="card-wrapper">
            <li class="card">
                ...
                <a href="cliente/insertar.php"><input type="button" value="Insertar Incidencia"></a>
            </li>
            <li class="card">
                ...
                <a href="cliente/gestion.php"><input type="button" value="Gestionar Incidencia"></a>
            </li>
            <li class="card">
                ...
                <a href=""><input type="button" value="Gestionar Usuarios"></a>
            </li>
        </ul>
    </main>
</body>
